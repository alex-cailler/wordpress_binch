    ...
    <div class="container-binch py-9">
        <?php if (have_posts()): ?>
            <div class="shadow rounded-lg">
                <div class="pt-9 mb-6">
                    <?php the_title('<h3 class="text-size-55 d-none d-md-block text-center font-weight-bold">','</h3>'); ?>
                    <?php the_title('<h3 class="text-size-25 d-md-none text-center font-weight-bold">','</h3>'); ?>
        ...
        <?php else: ?>
            ...
            <div class="empty">
                    <span class="empty-text text-center d-block">
                        <?php _e('There`\'s no posts to display', 'binch'); ?>
                    </span>
            </div>
